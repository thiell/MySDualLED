 ...
 *******************************
   MySDualLED for board iboat v1.0 (type Sensebender 8MHz)
   Board design by Julien Couthouis https://github.com/emc2cube
   Modified by Stephane Thiell
 *******************************
*/


// Select board at compile time
#define CABIN_MAIN_LIGHT                    1
#define HEAD_NAUTICAL_LIGHT                 0

//////////////////////////
//     Configuration    //
//////////////////////////

// This module supports a single press/click button support to control 2 lights with RED

#if CABIN_MAIN_LIGHT
String Location = "Cabin Main Light";
#define MY_NODE_ID 13
#elif HEAD_NAUTICAL_LIGHT
String Location = "Head Nautical Light";
...
static int8_t  toggleLED = 0;  // ST: added to be able to toggle LED1/LED2/off using push button
