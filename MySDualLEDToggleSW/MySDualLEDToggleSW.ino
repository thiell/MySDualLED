...
// Easy board selection for program upload
#define CABIN_READING_LIGHT_PT      0
#define CABIN_READING_LIGHT_SB      0
#define MAIN_OCEAN_LIGHT_PT         1
#define MAIN_OCEAN_LIGHT_SB         0

//////////////////////////
//     Configuration    //
//////////////////////////

// This module supports unlabelled toggle switch AND press/click button support

#if CABIN_READING_LIGHT_PT
String Location = "Cabin Light PT"; 
#elif CABIN_READING_LIGHT_SB
String Location = "Cabin Light SB"; 
#elif MAIN_OCEAN_LIGHT_PT
String Location = "Main Ocean Light PT"; 
#elif MAIN_OCEAN_LIGHT_SB
String Location = "Main Ocean Light SB";
#endif

// Lights with 1 LED and a single traditional On/Off toggle switch
#define LED1_CONTROL
#define LED1_DIMMER
//#define LED2_CONTROL
//#define LED2_DIMMER
